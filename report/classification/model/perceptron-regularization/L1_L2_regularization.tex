...
Trong đó $\Omega(\boldsymbol{w})$ là hạng phạt và $\lambda > 0$ điều khiển mức độ regularization. Giá trị $\lambda$ càng lớn thì ràng buộc càng mạnh, dẫn đến mô hình đơn giản hơn.
...
\[
\Omega(\boldsymbol{w}) = \|\boldsymbol{w}\|_2^2
\]

Khi đó:
\[
\mathcal{L}_{L2} =
\mathcal{L} + \lambda \|\boldsymbol{w}\|_2^2
\]
...
\[
\mathcal{L}_{L1} =
\mathcal{L} + \lambda \|\boldsymbol{w}\|_1
\]
