...
với:
\begin{gather}
  \mu_* = \boldsymbol{k}_*^\intercal \boldsymbol{K}^{-1} \boldsymbol{t}, \\
  \sigma_*^2 = k_{**} - \boldsymbol{k}_*^\intercal \boldsymbol{K}^{-1}
  \boldsymbol{k}_*.
\end{gather}
...
\begin{equation}
  ...
  -\frac{1}{2} \boldsymbol{t}^\intercal \boldsymbol{K}^{-1} \boldsymbol{t}
...
\begin{itemize}
    \item \textbf{Data fit term}: $\boldsymbol{t}^\intercal \boldsymbol{K}^{-1}
      \boldsymbol{t}$
