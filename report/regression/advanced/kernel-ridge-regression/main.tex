...
\tablename~\ref{tab:kernel-ridge-cross-validation-1} và
\tablename~\ref{tab:kernel-ridge-cross-validation-2} trình bày kết quả
...
\begin{table}[htbp]
  \caption{Kết quả cross-validation của các mô hình (phần 1)}
  \label{tab:kernel-ridge-cross-validation-1}
  \centering
  \import{\tablespath}{kernel-ridge-cross-validation-1}
\end{table}

\begin{table}[htbp]
  \caption{Kết quả cross-validation của các mô hình (phần 2)}
  \label{tab:kernel-ridge-cross-validation-2}
  \centering
  \import{\tablespath}{kernel-ridge-cross-validation-2}
\end{table}
