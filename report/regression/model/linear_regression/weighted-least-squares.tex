\paragraph{Bình phương tối thiểu có trọng số (Weighted Least Squares, WLS)}
...
\subparagraph{Phương trình chuẩn cho WLS}
...
\subparagraph{Ước lượng khả thi bằng FGLS (Feasible Generalized Least
Squares)}
...
\begin{itemize}[align=left,font=\bfseries]
  ...
  \item[Bước 1: Ước lượng ban đầu bằng OLS]
  ...
  \item[Bước 2: Mô hình hóa phương sai]
  ...
  \item[Bước 3: Ước lượng trọng số]
...
\subparagraph{Độ phức tạp tính toán}
...
Chi phí tính toán của FGLS bao gồm ba bước chính: \begin{itemize}
  \item Ước lượng OLS ban đầu: $\Theta(NM^2 + M^3)$, trong đó $\Theta(NM^2)$ để
    tính $\boldsymbol{\Phi}^\intercal \boldsymbol{\Phi}$ và $\Theta(M^3)$ để
    nghịch đảo ma trận.
  ...
  \item Ước lượng WLS: $\Theta(NM^2 + M^3)$, bao gồm việc tính
    $\boldsymbol{\Phi}^\intercal \boldsymbol{W} \boldsymbol{\Phi}$ và nghịch
    đảo ma trận tương ứng.
