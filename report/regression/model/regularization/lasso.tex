...
\begin{equation}
  E(\mathbf{w}) = \frac{1}{2} \|\mathbf{Xw} - \mathbf{t}\|^2 + \lambda \|
  \mathbf{w}\|_1.
\end{equation}
...
\begin{equation}
  ...
  \mathbf{w}\|_1 \leq C.
\end{equation}
Miền ràng buộc $\|\mathbf{w}\|_1 \leq C$ có dạng hình thoi (diamond). Khi kết
hợp với các đường đồng mức của hàm lỗi, nghiệm tối ưu thường rơi vào các đỉnh
của hình thoi, dẫn đến nhiều hệ số bằng 0.
