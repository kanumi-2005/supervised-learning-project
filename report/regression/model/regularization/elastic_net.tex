...
\begin{equation}
  E_W(\mathbf{w}) = \alpha \|\mathbf{w}\|_1 + \frac{1 - \alpha}{2} \|\mathbf{w
  }\|_2
\end{equation}
...
\begin{equation}
  E(\mathbf{w}) = \frac{1}{2} \|\mathbf{Xw} - \mathbf{t}\|^2
  + \lambda \left( \alpha \|\mathbf{w}\|_1 + \frac{1 - \alpha}{2} \|\mathbf{w}
  \|^2 \right)
\end{equation}
...
\begin{equation}
  \min_{\mathbf{w}} \|\mathbf{Xw} - \mathbf{t}\|^2
  \quad \text{với} \quad
  \alpha \|\mathbf{w}\|_1 + (1-\alpha)\|\mathbf{w}\|^2 \leq C
\end{equation}
