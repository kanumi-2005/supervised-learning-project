...
\begin{longtblr}[
  ...
  \SetCell[c=4]{l} Bài toán hồi quy & \\
  ...
  \SetCell[c=4]{l} Bài toán phân lớp \\
  Chọn bộ dữ liệu & 100\% & 100\% & 100\% \\
  Phân tích khám phá và tiền xử lí & 100\% \\
...
\begin{longtblr}[
  ...
  \SetCell[c=2]{l} Bài toán hồi quy \\
  ...
  \SetCell[c=2]{l} Bài toán phân lớp \\
  ...
  \SetCell[c=2]{l} Yêu cầu về Báo cáo \\
