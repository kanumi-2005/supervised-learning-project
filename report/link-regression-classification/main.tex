...
\paragraph{Logistic Regression như một bài toán hồi quy}
...
\paragraph{Khung Generalized Linear Models (GLM)}
Generalized Linear Models (GLM) cung cấp một khung thống nhất cho nhiều mô
hình hồi quy khác nhau. Trong GLM, ta giả định rằng:
\begin{itemize}
...
\paragraph{Vai trò của exponential family}
